...
let KycRepository = class KycRepository {
    async getUserById(userId) {
        return await user_models_1.default.findById(userId);
    }
    async updateUserKyc(userId, imageUrl, videoUrl) {
        return await user_models_1.default.findByIdAndUpdate(userId, {
            kycSubmitted: true,
